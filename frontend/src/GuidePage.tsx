...
const steps = [
  {
    ...
    details: [
      ...
      "「カラオケ音源アップロード」→ 歌入りファイル(.wav, .mp3, .mp4, .aac .m4a)を選択",
    ],
  },
  {
    icon: ChartBarIcon,
    ...
    borderGlow:
      "border-fuchsia-500/50 shadow-[0_0_15px_rgba(232,121,249,0.2)] group-hover:shadow-[0_0_30px_rgba(232,121,249,0.6)] group-hover:border-fuchsia-400",
  ...
  },
  {
    ...
    borderGlow:
      "border-yellow-500/50 shadow-[0_0_15px_rgba(250,204,21,0.2)] group-hover:shadow-[0_0_30px_rgba(250,204,21,0.6)] group-hover:border-yellow-400",
...
const tips = [
  ...
  {
    emoji: "🎤",
    text: "音源はmp3, m4a, aac, wav, flac形式に対応しています",
  },
            ...
            return (
              ...
              >
                ...
                >
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-2">
                        {step.details.map((d, j) => (
                          <li
                            key={j}
                            className="flex items-start gap-2 text-sm sm:text-base text-slate-400"
                          >
                  ...
                  ></div>
                  <div
                    className={`absolute bottom-0 left-0 w-16 h-1 border-b-2 border-l-2 ${step.decorationColor} opacity-50`}
                  ></div>
                </div>
              </div>
            );
