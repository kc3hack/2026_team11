    ...
    <header className="hidden md:flex items-center justify-between px-8 py-4 bg-slate-900/80 backdrop-blur-md border-b border-cyan-500/30 shadow-[0_0_15px_rgba(6,182,212,0.15)] sticky top-0 z-50">
      ...
      <nav className="hidden md:flex gap-8 text-sm font-medium text-slate-400">
        ...
        <button
          ...
          className={`${currentView === "history" ? "text-cyan-400 font-bold drop-shadow-[0_0_5px_rgba(34,211,238,0.8)]" : "hover:text-cyan-400 text-slate-400"} transition-all bg-transparent border-0 cursor-pointer`}
        >
          履歴
        </button>
      </nav>
